...
public class TicTacToeGame {
    ...
    public char getBoardOccupant(int i) {
        ...
        if(mBoard[i] == HUMAN_PLAYER) return HUMAN_PLAYER;
        else if(mBoard[i] == COMPUTER_PLAYER) return COMPUTER_PLAYER;
        else return OPEN_SPOT;
    ...
    public DifficultyLevel mDifficultyLevel = DifficultyLevel.Easy;
...
/*
    ...
    */
    public int getComputerMove() {
        ...
        if (getDifficultyLevel() == DifficultyLevel.Easy)
            move = getRandomMove();
        else if (getDifficultyLevel() == DifficultyLevel.Harder) {
            move = getWinningMove();
            if (move == -1)
                move = getRandomMove();
        }
        else if (getDifficultyLevel() == DifficultyLevel.Expert) {
